...
describe('AiAgent', () => {
    ...
    it('should create agent with correct properties', async () => {
        ...
        const result = agent.createAgent({ code: "console.log('Hello, World!');", name: "Test Agent", shard: "test" });
    ...
    it("should return agents list", async () => {
        ...
        expect(agents).toContainEqual(expect.objectContaining<AgentHeader>({
    ...
    it('should return agent by version', async () => {
        ...
        const agentData = await agent.getAgentVersion("fake agent id", "fake version id");
        expect(agentData).toEqual(expect.objectContaining<AgentHeader>({
            id: expect.any(String) as string,
            name: expect.any(String) as string,
            shard: expect.any(String) as string,
            version: expect.any(String) as string,
