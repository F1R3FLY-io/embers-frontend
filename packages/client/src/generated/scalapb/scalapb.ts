...
export const MessageOptions: MessageFns<MessageOptions> = {
  ...
  toJSON(message: MessageOptions): unknown {
    ...
    if (message.sealedOneofCompanionExtends?.length) {
      obj.sealedOneofCompanionExtends = message.sealedOneofCompanionExtends;
    }
    return obj;
  },
...
function createBaseFieldOptions(): FieldOptions {
  return {
    ...
    annotations: [],
    mapType: "",
    noDefaultValueInConstructor: false,
    noBox: false,
    required: false,
  };
}
  ...
  fromJSON(object: any): FieldOptions {
    return {
      ...
      annotations: globalThis.Array.isArray(object?.annotations)
        ...
        : [],
      mapType: isSet(object.mapType) ? globalThis.String(object.mapType) : "",
      noDefaultValueInConstructor: isSet(object.noDefaultValueInConstructor)
