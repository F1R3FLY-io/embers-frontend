  ...
  return (
    <div className={styles["deploy-container"]}>
      ...
      <div className={styles["stepper-container"]}>
        <Stepper currentStep={3} labels={["Create", "Configure", "Deploy"]} steps={3} />
      </div>
      <div className={styles["content-container"]}>
        ...
        <div className={styles["details-container"]}>
          ...
          <div className={styles["form-section"]}>
            ...
            <input className={styles["form-input"]} placeholder={agentName} type="text" />
          </div>
          <div className={styles["form-section"]}>
            <Text color="secondary" fontSize={12}>
              {t("deploy.agentDescription")}
            </Text>
            <textarea className={styles["form-textarea"]} placeholder={agentDescription} />
          </div>
          <div className={styles["form-section"]}>
            <Text bold color="primary" fontSize={20} type="H3">
          ...
          <div className={styles["form-section"]}>
            ...
            <div className={styles["form-fields"]}>
              <div>
                ...
                <input className={styles["form-input"]} placeholder={agentVersion} type="text" />
              </div>
              <div>
                <Text color="secondary" fontSize={12}>
                  {t("deploy.notes")}
