...
import { AgentsApiSdk, AgentsTeamsApiSdk, WalletsApiSdk } from "@f1r3fly-io/embers-client-sdk";
...
export function WalletProvider({ children }: React.PropsWithChildren) {
  const [embers, dispatch] = useReducer<EmbersAPI | undefined, [PrivateKey | undefined]>(
    (_, privateKey) =>
      privateKey && {
